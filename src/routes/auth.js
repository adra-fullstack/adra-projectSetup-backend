...
const { registerUser, forgotPassword, resetPassword, getUser, resetJwtToken, registerInterviewCandidate, login, get_registration_roles } = require("../controllers/authController");
